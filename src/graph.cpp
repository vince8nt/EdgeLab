...
public:
    ...
    /*
        ...
        Vertex(const Edge_t* edges_begin, vertex_ID_t degree) requires EmptyVertex<Vertex_t> :
        ...
        Vertex(const Vertex_t& vertex, const Edge_t* edges_begin, vertex_ID_t degree)
                requires NonEmptyVertex<Vertex_t> :
    ...
    */
        ...
        bool connected_to(vertex_ID_t target_id) const {
